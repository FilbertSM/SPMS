...
const Dashboard = () => {
  return (
    <div className="page-container bg-[#f1f4f3] p-8 space-y-8 min-h-screen">
      ...
      {/* SECTION 1: Header & Machine Status (Row Atas) */}
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl p-8 flex flex-col justify-between shadow-sm relative overflow-hidden">
          ...
          {/* Decorative Blob Graphic dari code.html */}
        ...
        {/* Status Box (Healthy Green Banner) */}
        <div className="bg-[#6bfe9c] rounded-xl p-8 flex flex-col items-center justify-center text-center space-y-4 shadow-md group">
      ...
      {/* SECTION 2: Telemetry & Insights (Row Tengah) */}
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Main Chart: Motor Current vs LSTM */}
          ...
          <div className="relative h-64 w-full px-2">
            ...
            <div className="ml-8 h-full relative">
              ...
              <div className="absolute top-[15%] w-full border-t border-[#ba1a1a]/60 border-dashed z-10 flex justify-end">
                <span className="text-[8px] font-headline font-bold text-[#ba1a1a] bg-white px-1 -mt-2">Threshold: 8.5A</span>
              </div>
              {/* Graph SVG */}
        ...
        <div className="lg:col-span-4 bg-white rounded-xl p-6 shadow-sm flex flex-col justify-between">
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <p className="text-[10px] text-center text-[#45474d] mt-4 leading-relaxed">
              Mean Squared Error (MSE) is currently within the safety threshold (Threshold: 0.150)
            </p>
          </div>
          <div className="mt-6 pt-6 border-t border-[#c5c6cd]/10 flex items-center justify-between">
            ...
            <div className="flex gap-1">
              <span className="w-1 h-3 bg-[#006d37] rounded-full"></span>
              <span className="w-1 h-3 bg-[#006d37] rounded-full"></span>
              <span className="w-1 h-3 bg-[#006d37] rounded-full"></span>
              <span className="w-1 h-3 bg-[#006d37] rounded-full opacity-30"></span>
            </div>
          </div>
        </div>
      </section>

      {/* SECTION 3: Vibration Peak & Sensor Health (Row Paling Bawah) */}
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Vibration Peak Acceleration Chart */}
        <div className="lg:col-span-7 bg-white rounded-xl p-6 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs font-bold text-[#006d37] bg-[#6bfe9c] px-3 py-1 rounded-full">0.82 g-RMS</span>
          </div>
          
          {/* Waveform Line Chart */}
          <div className="h-32 w-full flex items-center">
            <svg className="w-full h-full" viewBox="0 0 400 100">
              <path className="text-[#006d37]" d="M0 80 Q 20 20, 40 50 T 80 40 T 120 70 T 160 30 T 200 60 T 240 40 T 280 80 T 320 30 T 360 50 T 400 70" fill="none" stroke="currentColor" strokeWidth="2"></path>
              <path className="text-[#006d37]/10" d="M0 80 Q 20 20, 40 50 T 80 40 T 120 70 T 160 30 T 200 60 T 240 40 T 280 80 T 320 30 T 360 50 T 400 70 V 100 H 0 Z" fill="currentColor"></path>
            </svg>
          </div>
        ...
        <div className="lg:col-span-5 bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* Temp S-01 */}
            <div className="p-4 rounded-lg bg-[#f1f4f3] flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-[#1b263b] text-lg">thermostat</span>
                <span className="text-xs font-bold text-[#051125]">Temp S-01</span>
              </div>
              <span className="w-2 h-2 bg-[#006d37] rounded-full"></span>
            </div>
            {/* RPM M-04 */}
            <div className="p-4 rounded-lg bg-[#f1f4f3] flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-[#1b263b] text-lg">speed</span>
                <span className="text-xs font-bold text-[#051125]">RPM M-04</span>
              </div>
              <span className="w-2 h-2 bg-[#006d37] rounded-full"></span>
            </div>
            {/* Moist P-11 */}
            <div className="p-4 rounded-lg bg-[#f1f4f3] flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-[#1b263b] text-lg">water_drop</span>
                <span className="text-xs font-bold text-[#051125]">Moist P-11</span>
              </div>
              <span className="w-2 h-2 bg-[#006d37] rounded-full"></span>
            </div>
            {/* Pres A-02 */}
            <div className="p-4 rounded-lg bg-[#f1f4f3] flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-[#1b263b] text-lg">compress</span>
                <span className="text-xs font-bold text-[#051125]">Pres A-02</span>
              </div>
